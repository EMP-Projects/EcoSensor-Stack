...
pg_pass=$(aws ssm get-parameter --with-decryption --profile default --name "ECOSENSOR_PG_PASS" --query "Parameter.Value" --output text) 
pg_pass_osm=$(aws ssm get-parameter --with-decryption --profile default --name "ECOSENSOR_OSM_PASS" --query "Parameter.Value" --output text) 
pg_pass_istat=$(aws ssm get-parameter --with-decryption --profile default --name "ECOSENSOR_ISTAT_PASS" --query "Parameter.Value" --output text) 
